...
-Se till att skapa en egen användare/eller välj en av de autogenererade(http://localhost:3000/login, eller den port du väljer att köra istället för 3000)
...
fyll bara in dina uppgifter u headern.
